...
def editar_debate(request, debate_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            debate.titulo = info['titulo']
            debate.subtitulo = info['subtitulo']
            debate.cuerpo = info['cuerpo']
            debate.imagen = info['imagen']
            ...
            form = DebateForm(initial = {'titulo':debate.titulo, 
                                        'subtitulo':debate.subtitulo, 
                                        'cuerpo':debate.cuerpo, 
                                        'imagen':debate.imagen})

            return redirect( 'editar_debate' )
            ...
            return render(requestm r'hablemosapp/editar_debate.html', {'form':form} )
