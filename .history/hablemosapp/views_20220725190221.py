...
from .models import AboutUs, Comentario, Debate, Avatar, User, Mensaje
...
def editar_avatar(request):
    ...
    formulario = AvatarForm(initial={'imagen':avatar.imagen})

    return render(request, r'hablemosapp/editar_avatar.html',{'form':formulario, 'url':url})    
...
def about_us(request):
    ...
    return render(request, r'hablemosapp/about_us.html', ctx )