...
class ComentarioForm(forms.Form):
    ...
    comentario = forms.CharField(label='comentario', widget=forms.Textarea, max_length=150)
    autor = forms.ForeignKey(User, on_delete=models.CASCADE,related_name='comentario_autor', null=True)
