    ...
    if user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if search != '':
                ...
                busqueda = Debate.objects.filter(titulo__icontains = search).distinct

                return render(request, r'hablemosapp/debates.html', {'busqueda':busqueda, 'mensajes':mensajes, 'busqueda':search})
