    ...
    if user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if buscar != '':
                ...
                busqueda = Debate.objects.filter(titulo__icointains = buscar)

                return render(request, r'hablemosapp/debates.html', {'debates':debates,'busqueda':busqueda,'mensajes':mensajes})
