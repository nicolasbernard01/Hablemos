...
def editar_perfil(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form = UserEditForm(initial = {'first_name':user.first_name, 'last_name':user.apellido, 'email':user.email})
    
    else:

        form = UserEditForm(initial = {'nombre':user.nombre, 'apellido':user.apellido, 'email':user.email})   
