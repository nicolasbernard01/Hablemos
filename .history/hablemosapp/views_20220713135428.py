...
from .forms import AvatarForm, UserCreationForm, UserEditForm,UserRegisterForm
...
def user_avatar(request):
    ...
    if request.method == 'POST':
        ...
        if form_avatar.is_valid():
            ...
            avatar = Avatar(usuario=user, imagen = form_avatar.cleaned_data['imagen'])
    ...
    return render(request,r'hablemosapp/user_avatar.html', {'form_avatar':form_avatar, form})
