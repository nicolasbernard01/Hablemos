...
class DebateForm(forms.Form):
    ...
    cuerpo = forms.CharField(label='cuerpo', require=True)
    imagen = forms.ImageField(label='imagen', required=False, upload_to = 'PostImagen/', blank=True, null=True)
    autor = forms.CharField(User)
