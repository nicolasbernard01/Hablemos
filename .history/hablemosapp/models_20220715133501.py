...
class Debate(models.Model):
    ...
    autor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='autor_debate')


class Comentario(models.Model):

    autor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='autor_cometario', null=True )
