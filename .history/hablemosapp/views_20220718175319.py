    ...
    if user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if search != '':
                ...
                busqueda = Debate.objects.filter(titulo__icontains = search).values

                return render(request, r'hablemosapp/debates.html', {'busqueda':busqueda, 'search':True, 'mensajes':mensajes, 'busqueda':search})
