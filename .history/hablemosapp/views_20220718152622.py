    ...
    if user.is_authenticated:
        ...
        if request.post=='POST':
            ...
            if search != '':
                ...
                debates_filtered = Debate.objects.filter(titulo__icontains = search).values

                return  render(request, r'hablemos/debates.html', {'debates_filtered':debates_filtered, 'search':True})
