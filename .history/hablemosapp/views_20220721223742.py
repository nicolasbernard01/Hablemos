...
def crear_comentario(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            nuevo_comentario = Comentario(autor=request.user, debate=Debate.objects.get(id=info['id']), comentario = info['comentario'])

            nuevo_comentario.save()

            return redirect('debates/<id>')
        ...
        return render(request, 'hablemosapp/debates.html', {'form':form})
