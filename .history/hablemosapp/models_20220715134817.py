...
class Debate(models.Model):
    ...
    autor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='debate_autor', primary_key=True)


class Comentario(models.Model):

    autor = models.ForeignKey(User, on_delete=models.CASCADE,related_name='comentario_autor', primary_key=True)
